 ...
 * https://spring.io/guides/topicals/spring-security-architecture/, it is not a
 * bad idea to also use method security (via @Secured annotations in methods)
 * 
 * @author mfreire
 */
@EnableWebSecurity
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * 
	 * Adding paths to the ignoring() part allows fully-unsecured access to those
	 * paths
	 */
	@Override
	 ...
	 * access to a resource, a later rule cannot deny that access, and vice-versa.
	 * 
	 * To disable security entirely, just add an .antMatchers("**").permitAll() as a
	 * first rule. Note that this may break an application that expects to have
	 ...
	 * 
	 * This allows you to write, in any part of Spring-managed code, `@Autowired
	 * PasswordEncoder passwordEncoder`, and have it initialized with the result of
	 * this method.
	 */
	@Bean
